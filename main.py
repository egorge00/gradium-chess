        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "REGLES STRICTES ET OBLIGATOIRES :\n"
                    "- 1 phrase, 2 maximum\n"
                    ...
                    "- ecrire en francais SANS AUCUN ACCENT\n\n"
                    "STYLE :\n"
                    "- familier\n"
                    "- complice\n"
                    "- vivant\n"
                    ...
                    "--------------------------------\n\n"
                    "Tu es le COACH.\n"
                    "Tu parles au joueur en disant tu.\n\n"
                    "Objectif :\n"
                    "- reagir a chaud\n"
                    "- commenter UNE idee simple\n"
                    "- encourager ou taquiner gentiment\n\n"
                    "Exemples :\n"
                    "- Allez, tu ouvres le centre, bonne idee.\n"
                    "- Ouh la, ta dame est exposee.\n"
            ...
            },
            {
                "role": "user",
                "content": (
                    f"Role: {role}. Coup joue (notation UCI): {move_uci}. "
